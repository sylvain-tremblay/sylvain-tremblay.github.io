...
const messages = {
  fr: {
    ...
    bioParas: [
      ...
      <>En 2026, il crée sa propre <a href="https://editionsst.com/" target="_blank" rel="noreferrer" className="underline decoration-fuchsia-400/70 underline-offset-2 hover:text-white">maison d’édition</a> pour donner une continuité éditoriale à son travail : des ouvrages ancrés dans la pratique, la clarté et l’autonomie des lecteurs, qu’il s’agisse de technologie, de création ou de livres illustrés.</>,
